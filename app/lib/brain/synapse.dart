...
class Synapse {
  ...
  factory Synapse.fromJson({
    ...
    return Synapse(
      ...
      // ADESSO:
      relationship:
          json['relationship'] ?? 'relatedTo',



      weight:
          (json['weight'] ?? 0.2).toDouble(),


      confidence:
          (json['confidence'] ?? 0.5).toDouble(),


      plasticity:
          (json['plasticity'] ?? 1.0).toDouble(),


      decayRate:
          (json['decayRate'] ?? 0.001).toDouble(),


      activation:
          (json['activation'] ?? 0.0).toDouble(),
